...
$menu[] = array(__('Tambah Karya Tulis'), MWB.'membership/add_essay.php', __('Tambah Karya Tulis'));
...
$menu[] = array(__('Cetak Surat Bebas Perpus'), MWB.'membership/member_free_loan_letter.php', __('Cetak Surat Bebas Perpus'));
